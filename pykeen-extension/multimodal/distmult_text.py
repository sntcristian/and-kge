...
class DistMultText(DistMult, MultimodalModel):
    ...
    def __init__(
        ...
        self.num_of_literals = self.textual_literals.embedding_dim
    ...
    def _get_entity_representations(
        ...
        lit = self.textual_literals.get_in_canonical_shape(indices=idx)
